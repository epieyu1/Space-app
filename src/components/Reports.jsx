...
const Reports = ({ transactions, expenses }) => {
  ...
  const monthlyData = useMemo(() => { 
      ...
      // Usa amountCOP o amount
      transactions.forEach(t => { const d = t.date?.toDate ? t.date.toDate() : new Date(t.date.seconds * 1000); if (d.getFullYear() === year) data[d.getMonth()].income += Number(t.amountCOP || t.amount); }); 
